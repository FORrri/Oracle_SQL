...
CREATE TABLE DEPTS(
        ...
        --ALTER TABLE DEPTS ADD CONSTRAINT mem_memnum_pk PRIMARY KEY (M_NUM)
...
INSERT INTO DEPTS VALUES('AAA', 1, '2018-07-01', 'M', 1800);

INSERT INTO DEPTS VALUES('BBB', 2, '2018-07-02', 'F', 1900);

INSERT INTO DEPTS VALUES('CCC', 3, '2018-07-03', 'M', 2000);

INSERT INTO DEPTS VALUES('DDD', 4, '2018-07-04', 'M', 2000);

--문제2.
--
--도서 대여 이력 테이블을 생성하려 합니다.
--도서 대여 이력 테이블은
--대여번호(숫자) PK, 대출도서번호(문자)FK , 대여일(날짜), 반납일(날짜), 반납여부(Y/N)
--를 가집니다.
--적절한 테이블을 생성해 보세요.
DESC RENTALS;
...
CREATE TABLE RENTALS(
    ...
    ALTER TABLE RENTALS ADD CONSTRAINT RENTALS_YN CHECK(RENTALS_YN IN ('Y','N'));
